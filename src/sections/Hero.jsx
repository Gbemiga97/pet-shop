...
const Hero = () => {
  return (
   ...
   <div className="container mx-auto flex justify-start items-center min-h-[400px] lg:h-[805px]">
    <div className="lg:max-w-[750px] text-center mx-auto lg:text-left lg:mx-0">

      <div className="hidden xl:flex  mb-6 ml-5">
        <img 
        className="w-full h-auto"
        src={images.HeroPretitle}
         alt="pre-title" />
      </div>
      <h1 className="text-5xl lg:text-8xl w-full uppercase font-bold -tracking-[0.05em] mb-10">
        A pet first <br /> 
